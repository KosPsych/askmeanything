              ...
              <body className="signup-body">
                ...
                <Grid className="body-signup dispay">
                  <Cell large={10} medium={10}>
                    ...
                    <form name="signup" action="/action_page.php" classNameonsubmit="return validateForm()" method="post">
                      <div className="signup">
                        ...
                        <input id="repassword" type="password" placeholder="RePassword" name="repswrd" required />
                        <input type="button" onClick={this.handleSubmit.bind(this)} value="Sign up" />
                      </div>
                    </form>
                  </Cell>
                </Grid>
